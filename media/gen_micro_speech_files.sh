#!/bin/bash
# This program makes generating mirco_speech samples suitable for the
# STM32 Discovery boards more easier
#
...
do
  ...
  do
    ...
    FILE_NAME=`echo $RANDOM_FILE | sed s/"_nohash"// | awk -F/ '{print $(NF-1)"_"$NF}'`
